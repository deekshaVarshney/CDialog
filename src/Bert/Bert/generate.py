...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_dir', default='weights/english/no_kg/29model.pth', type=str, required=False)
    parser.add_argument('--test_load_dir', default='../data/test_data.pkl', type=str, required=False)
    parser.add_argument('--pred_save_dir', default='Results/no_kg/pred.txt', type=str, required=False)
    parser.add_argument('--reference_save_dir', default='Results/no_kg/reference.txt', type=str, required=False)
    parser.add_argument('--metric_save_dir', default='Results/no_kg/scores.txt', type=str, required=False)
    parser.add_argument('--output_save_dir', default='Results/no_kg/Out.csv', type=str, required=False)
