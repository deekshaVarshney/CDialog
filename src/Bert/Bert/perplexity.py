...
parser.add_argument('--load_dir', default='weights/english/no_kg/29model.pth', type=str, required=False)
...
parser.add_argument('--save_dir', default='Results/no_kg/ppl.txt', type=str, required=False)
