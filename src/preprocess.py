...
parser.add_argument('--HCM_datapath', default='MedDialogCorpus/HCM/', type=str, required=False)
parser.add_argument('--Icliniq_datapath', default='MedDialogCorpus/Icliniq/', type=str, required=False)
parser.add_argument('--json_datapath', default='MedDialogCorpus/json_files/', type=str, required=False)
parser.add_argument('--merged_datapath', default='MedDialogCorpus/json_files/merged/merged_file.json', type=str, required=False)
...
result = []
for filename in glob.glob("MedDialogCorpus/json_files/*.json"):
