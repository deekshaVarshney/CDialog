...
if __name__ == '__main__':
    ...
    top_k = 50
    temperature = 1.0
    decoder_path='weights/english/no_kg/29model.pth'#'decoder.pth'
    gpu_id=0
    # ):
    ...
    checkpoint = torch.load("weights/english/no_kg/29model.pth")
    ...
    #------------------------LOAD VALIDATE DATA------------------
    test_data = torch.load("../data_biobert/test_data.pkl")
