...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(decoder_path, map_location='cuda:7')
    ...
    for batch_id, batch in enumerate(test_dataloader):
        with torch.no_grad():
            ...
            # should we change the above into this
            # encoder_input, decoder_input, mask_encoder_input, mask_decoder_input = batch

            # past = model.encoder(encoder_input, mask_encoder_input,decoder_input,mask_decoder_input)
            ...
            for i in range(100):
                ...
                logits = model.encoder(encoder_input, mask_encoder_input,decoder_input_ids= sentence)
