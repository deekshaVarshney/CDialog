...
make_dataset(data[0], 'preprocessed_data/data_biobert/train_data.pkl')

print(f'Process the validate dataset')
make_dataset(data[1], 'preprocessed_data/data_biobert/validate_data.pkl')

print(f'Process the test dataset')
make_dataset(data[2], 'preprocessed_data/data_biobert/test_data.pkl')
