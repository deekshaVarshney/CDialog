...
json_file1 = 'Data_entity/json_files/merged/merged_file.json'
json_file2 = 'Data_entity/entity_json_files/merged/merged_entity_file.json'
...
make_dataset(data[0],entity[0], 'preprocessed_data/data_biobert_entity_random/train_data.pkl')

print(f'Process the validate dataset')
make_dataset(data[1],entity[1], 'preprocessed_data/data_biobert_entity_random/validate_data.pkl')

print(f'Process the test dataset')
make_dataset(data[2],entity[2], 'preprocessed_data/data_biobert_entity_random/test_data.pkl')
