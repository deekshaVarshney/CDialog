...
if __name__ == '__main__':
    ...
    gpu_id=0
    lr=1e-5
    load_dir='weights/english/no_kg/'
    save_every = 10
    # ):
    ...
    #------------------------LOAD TRAIN DATA------------------
    train_data = torch.load("../data_biobert/train_data.pkl")

# 
    train_dataset = TensorDataset(*train_data)
    train_dataloader = DataLoader(dataset=train_dataset, shuffle=True, batch_size=batch_size)
    val_data = torch.load("../data_biobert/validate_data.pkl")
