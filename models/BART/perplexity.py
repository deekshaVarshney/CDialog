...
parser.add_argument('--validate_load_dir', default='../../preprocessed_data/data_entity_random/validate_data.pkl', type=str,
                    required=False)
parser.add_argument('--test_load_dir', default='../../preprocessed_data/data_entity_random/test_data.pkl', type=str,
                    required=False)
parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_entity_random/train_data.pkl', type=str,
                    required=False)
...
def calculate(
    ...
    PATH = args.load_dir
    checkpoint = torch.load(PATH, map_location='cuda:7')
